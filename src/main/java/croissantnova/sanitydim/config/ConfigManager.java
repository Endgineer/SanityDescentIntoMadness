...
public abstract class ConfigManager {
    ...
    public static void loadProxies() {
        ...
        proxies.put("sanity.passive.seasonEarlySummer", new ProxyValueEntry<>(() -> getConfigValues().m_seasonEarlySummer.get(), ConfigManager::finalizePassive));
        proxies.put("sanity.passive.seasonMidSummer", new ProxyValueEntry<>(() -> getConfigValues().m_seasonMidSummer.get(), ConfigManager::finalizePassive));
        proxies.put("sanity.passive.seasonLateSummer", new ProxyValueEntry<>(() -> getConfigValues().m_seasonLateSummer.get(), ConfigManager::finalizePassive));
        proxies.put("sanity.passive.seasonEarlyAutumn", new ProxyValueEntry<>(() -> getConfigValues().m_seasonEarlyAutumn.get(), ConfigManager::finalizePassive));
        proxies.put("sanity.passive.seasonMidAutumn", new ProxyValueEntry<>(() -> getConfigValues().m_seasonMidAutumn.get(), ConfigManager::finalizePassive));
        proxies.put("sanity.passive.seasonLateAutumn", new ProxyValueEntry<>(() -> getConfigValues().m_seasonLateAutumn.get(), ConfigManager::finalizePassive));
        proxies.put("sanity.passive.seasonEarlyWinter", new ProxyValueEntry<>(() -> getConfigValues().m_seasonEarlyWinter.get(), ConfigManager::finalizePassive));
        proxies.put("sanity.passive.seasonMidWinter", new ProxyValueEntry<>(() -> getConfigValues().m_seasonMidWinter.get(), ConfigManager::finalizePassive));
        proxies.put("sanity.passive.seasonLateWinter", new ProxyValueEntry<>(() -> getConfigValues().m_seasonLateWinter.get(), ConfigManager::finalizePassive));
